          ...
          {[
            {
              title: 300,
              subtitle:
                "300 + PGs, Apartments and Villas which will help you live your best life in Gurgaon.",
              suffix: "+",
            },
            {
              title: 45,
              subtitle: "45 + amenities to choose from to live life your way.",
              suffix: "+",
            },
            {
              title: 99,
              subtitle:
                "99% of our customers rated 5-star our services over 5 years.",
              suffix: "%",
            },
          ].map((item, i) => (
